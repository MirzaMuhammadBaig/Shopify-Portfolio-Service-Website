...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'IN_PROGRESS', 'COMPLETED', 'DELIVERED', 'CANCELLED');
...
-- CreateIndex
CREATE INDEX "custom_offers_user_id_idx" ON "custom_offers"("user_id");
...
-- AddForeignKey
ALTER TABLE "orders" ADD CONSTRAINT "orders_custom_offer_id_fkey" FOREIGN KEY ("custom_offer_id") REFERENCES "custom_offers"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "custom_offers" ADD CONSTRAINT "custom_offers_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
