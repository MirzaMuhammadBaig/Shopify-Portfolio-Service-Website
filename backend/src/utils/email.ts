  ...
  await transporter.sendMail({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0A0A1B; color: #ffffff; padding: 40px; border-radius: 16px;">
        ...
        <p style="color: #666; font-size: 12px; text-align: center; margin-top: 24px;">
          ${data.isAdmin ? 'This is an automated notification from ShopifyPro.' : 'If you have questions, please contact us through our website.'}
        </p>
      </div>
    `,
  });
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0A0A1B; color: #ffffff; padding: 40px; border-radius: 16px;">
        ...
        <p style="color: #B0B0C0; font-size: 15px; line-height: 1.6; margin-bottom: 24px;">
          You can track your order progress from your dashboard.
        </p>
        <div style="text-align: center; margin: 32px 0;">
        ...
        <p style="color: #666; font-size: 12px; text-align: center; margin-top: 24px;">
          If you have any questions, please contact us through our website. We're here to help!
        </p>
      </div>
    `,
  });
